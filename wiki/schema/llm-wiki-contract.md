# AWS Control Tower SOC 2 Automation Suite Wiki — LLM Wiki Contract
...
## What this is
A git-native markdown knowledge base under `wiki/`, owned by **aws-soc2-setup**, maintained by the
...
## Sources & connectors
Enabled connectors: git, memory, roles.
